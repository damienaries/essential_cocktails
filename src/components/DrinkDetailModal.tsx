...
import { ShareDrinkButton } from './ShareDrinkButton';
import { AddToMenuButton } from './menus/AddToMenuButton';
import { DrinkMenuPills } from './menus/DrinkMenuPills';
              ...
              right of the details panel. */}
					...
					<div
						...
						<div className="absolute right-3 bottom-3 z-20 flex flex-col items-center gap-2">
							<AddToMenuButton drinkId={drink.id} />
							<SaveDrinkButton
								drinkId={drink.id}
								drinkName={drink.name}
								size="md"
							/>
							<ShareDrinkButton drink={drink} />
						</div>
					...
					<div
						...
						<DrinkMenuPills drinkId={drink.id} />
					</div>
				</motion.div>
			</AnimatePresence>
		</Modal>
